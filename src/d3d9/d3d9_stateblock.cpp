...
namespace dxvk {
  ...
  void D3D9StateBlock::CapturePixelRenderStates() {
    ...
    m_captures.renderStates.set(D3DRS_LASTPIXEL, false);
    ...
    m_captures.renderStates.set(D3DRS_STENCILENABLE, false);
    m_captures.renderStates.set(D3DRS_STENCILFAIL, false);
    m_captures.renderStates.set(D3DRS_STENCILZFAIL, false);
    m_captures.renderStates.set(D3DRS_STENCILPASS, false);
    m_captures.renderStates.set(D3DRS_STENCILFUNC, false);
    m_captures.renderStates.set(D3DRS_STENCILREF, false);
    m_captures.renderStates.set(D3DRS_STENCILMASK, false);
    m_captures.renderStates.set(D3DRS_STENCILWRITEMASK, false);
